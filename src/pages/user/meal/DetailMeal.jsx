...
export default function DetailMeal() {
  ...
  return (
    <div>
      ...
      <div className="border border-[#262522]/25 rounded-3xl mt-24 mb-16 mx-10 p-6">
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="px-3 mt-2">
            <span className="bg-[#9FDC26] border border-black px-3 py-1 rounded-full mr-2">
              📍 {meal[0]?.strArea}
            </span>
            <span className="bg-[#9FDC26] border border-black px-3 py-1 rounded-full mr-2">
              🍴 {meal[0]?.strCategory}
        ...
        <div className="flex gap-6 my-8 justify-center items-center md:items-start">
          ...
          <div className="w-5/12">
            ...
            {meal[0]?.strSource && (
              <div className={`${tags ? "my-6" : "my-5"}`}>
                <span className="text-[#F29C33] font-medium">Source : </span>
                <a
        ...
        <div className="flex flex-col md:flex-row gap-5">
          <div className="w-10/12">
            <h1 className="text-2xl font-bold uppercase">Instructions</h1>
          ...
          <div className="w-10/12">
            ...
            <div className="bg-[#FFFBF2] w-7/12 rounded-3xl p-3 flex flex-col h-max mx-auto">
